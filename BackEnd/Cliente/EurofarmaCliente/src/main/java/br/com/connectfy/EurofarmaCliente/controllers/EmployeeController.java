...
public class EmployeeController {
    ...
    @PatchMapping(value = "/updatePassword/{id}", produces = "aplication/json")
    ...
    @PatchMapping(value = "/changePhone/{id}", produces = "aplication/json")
    ...
    @PatchMapping(value = "/disable/{id}", produces = "aplication/json")
