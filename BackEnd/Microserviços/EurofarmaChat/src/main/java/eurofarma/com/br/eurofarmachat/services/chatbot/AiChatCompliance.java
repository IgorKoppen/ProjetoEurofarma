...
public interface AiChatCompliance extends AiChat {
    @SystemMessage("Você é um assistente de inteligência artificial especializado" +
            ...
            " perguntas que não estejam relacionadas ao compliance. Seu objetivo é fornecer informações precisas e úteis sobre compliance é fornecer o embasamento com trechos achados.")
