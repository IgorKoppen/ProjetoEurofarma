...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    challenge2024AuthUserSubject.add(
      Challenge2024AuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<Challenge2024AuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  Challenge2024AuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = Challenge2024AuthUser(
      loggedIn: true,
      uid: authUid,
      userData: userData,
    );
    challenge2024AuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
...
Challenge2024AuthUser? currentUser;
